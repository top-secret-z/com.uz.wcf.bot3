...
class UzbotAction extends AbstractDatabaseObjectAction implements IToggleAction {
	...
	public function create() {
		...
		// labels
		if (!empty($this->parameters['actionLabelIDs'])) UzbotActionLabelObjectHandler::getInstance()->setLabels($this->parameters['actionLabelIDs'], $bot->botID);
		if (!empty($this->parameters['conditionLabelIDs'])) UzbotConditionLabelObjectHandler::getInstance()->setLabels($this->parameters['conditionLabelIDs'], $bot->botID);
		if (!empty($this->parameters['notifyLabelIDs'])) UzbotNotificationLabelObjectHandler::getInstance()->setLabels($this->parameters['notifyLabelIDs'], $bot->botID);
