...
class UzbotAddForm extends AbstractForm {
	...
	public $cirStartTime = '';
	public $cirStartDateTime = null;
	public $cirTimezone = '';
	public $cirTimezoneObj = null;
	...
	public $groupAssignmentGroupID = null;
	...
	public function readData() {
		...
		$this->availableGroupsPassive = UserGroup::getAccessibleGroups(array(), array(UserGroup::GUESTS, UserGroup::EVERYONE, UserGroup::USERS));
	...
	public function readFormParameters() {
		...
		if (isset($_POST['botDescription'])) $this->botDescription = StringUtil::trim($_POST['botDescription']);
		if (isset($_POST['botTitle'])) $this->botTitle = StringUtil::trim($_POST['botTitle']);
		if (isset($_POST['categoryID'])) $this->categoryID = intval($_POST['categoryID']);
		if (isset($_POST['enableLog'])) $this->enableLog = 1;
		if (isset($_POST['isDisabled'])) $this->isDisabled = 1;
		if (isset($_POST['testMode'])) $this->testMode = 1;
		
		// read notify data
		$this->articlePublicationStatus = $this->commentActivity = $this->emailPrivacy = 0;
		if (isset($_POST['notifyID'])) $this->notifyID = intval($_POST['notifyID']);
		if (isset($_POST['articleCategoryID'])) $this->articleCategoryID = intval($_POST['articleCategoryID']);
		if (isset($_POST['articleConditionCategoryID'])) $this->articleConditionCategoryID = intval($_POST['articleConditionCategoryID']);
		if (isset($_POST['articleConditionCategoryID_new'])) $this->articleConditionCategoryID_new = intval($_POST['articleConditionCategoryID_new']);
		if (isset($_POST['articleEnableComments'])) $this->articleEnableComments = intval($_POST['articleEnableComments']);
		if (isset($_POST['articlePublicationStatus'])) $this->articlePublicationStatus = intval($_POST['articlePublicationStatus']);
		if (isset($_POST['commentActivity'])) $this->commentActivity = intval($_POST['commentActivity']);
		if (isset($_POST['condense']) && is_array($_POST['condense'])) $this->condense = ArrayUtil::trim($_POST['condense']);
		if (isset($_POST['content']) && is_array($_POST['content'])) $this->content = ArrayUtil::trim($_POST['content']);
		if (isset($_POST['conversationAllowAdd'])) $this->conversationAllowAdd = intval($_POST['conversationAllowAdd']);
		if (isset($_POST['conversationClose'])) $this->conversationClose = intval($_POST['conversationClose']);
		if (isset($_POST['conversationInvisible'])) $this->conversationInvisible = StringUtil::trim($_POST['conversationInvisible']);
		if (isset($_POST['conversationLeave'])) $this->conversationLeave = intval($_POST['conversationLeave']);
		if (isset($_POST['conversationType'])) $this->conversationType = intval($_POST['conversationType']);
		if (isset($_POST['emailBCC'])) $this->emailBCC = StringUtil::trim($_POST['emailBCC']);
		if (isset($_POST['emailCC'])) $this->emailCC = StringUtil::trim($_POST['emailCC']);
		if (isset($_POST['emailPrivacy'])) $this->emailPrivacy = intval($_POST['emailPrivacy']);
		if (isset($_POST['emailAttachmentFile'])) $this->emailAttachmentFile = StringUtil::trim($_POST['emailAttachmentFile']);
		if (isset($_POST['notifyLanguageID'])) $this->notifyLanguageID = intval($_POST['notifyLanguageID']);
		if (isset($_POST['receiverAffected'])) $this->receiverAffected = intval($_POST['receiverAffected']);
		if (isset($_POST['receiverGroupIDs']) && is_array($_POST['receiverGroupIDs'])) $this->receiverGroupIDs = ArrayUtil::toIntegerArray($_POST['receiverGroupIDs']);
		if (isset($_POST['receiverNames'])) $this->receiverNames = StringUtil::trim($_POST['receiverNames']);
		if (isset($_POST['sendername'])) $this->sendername = StringUtil::trim($_POST['sendername']);
		...
		if (isset($_POST['actionLabelIDs']) && is_array($_POST['actionLabelIDs'])) $this->actionLabelIDs = $_POST['actionLabelIDs'];
		else $this->actionLabelIDs = [];
		if (isset($_POST['conditionLabelIDs']) && is_array($_POST['conditionLabelIDs'])) $this->conditionLabelIDs = $_POST['conditionLabelIDs'];
		else $this->conditionLabelIDs = [];
		if (isset($_POST['notifyLabelIDs']) && is_array($_POST['notifyLabelIDs'])) $this->notifyLabelIDs = $_POST['notifyLabelIDs'];
		else $this->notifyLabelIDs = [];
		
		
		$this->condenseEnable = $this->actionLabelDelete = $this->articlePublished = $this->birthdayForce = $this->changeAffected = 0;
		if (isset($_POST['actionLabelDelete'])) $this->actionLabelDelete = intval($_POST['actionLabelDelete']);
		if (isset($_POST['articlePublished'])) $this->articlePublished = intval($_POST['articlePublished']);
		if (isset($_POST['birthdayForce'])) $this->birthdayForce = intval($_POST['birthdayForce']);
		if (isset($_POST['changeAffected'])) $this->changeAffected = intval($_POST['changeAffected']);
		if (isset($_POST['condenseEnable'])) $this->condenseEnable = intval($_POST['condenseEnable']);
		
		if (isset($_POST['cirCounterInterval'])) $this->cirCounterInterval = intval($_POST['cirCounterInterval']);
		if (isset($_POST['cirCounter'])) $this->cirCounter = intval($_POST['cirCounter']);
		if (isset($_POST['cirRepeatCount'])) $this->cirRepeatCount = intval($_POST['cirRepeatCount']);
		if (isset($_POST['cirRepeatType'])) $this->cirRepeatType = $_POST['cirRepeatType'];
		if (isset($_POST['cirStartTime'])) $this->cirStartTime = $_POST['cirStartTime'];
		if (isset($_POST['cirTimezone'])) $this->cirTimezone = $_POST['cirTimezone'];
		if (isset($_POST['cirMonthlyDoM_day'])) $this->cirMonthlyDoM_day = intval($_POST['cirMonthlyDoM_day']);
		if (isset($_POST['cirMonthlyDoW_index'])) $this->cirMonthlyDoW_index = intval($_POST['cirMonthlyDoW_index']);
		if (isset($_POST['cirMonthlyDoW_day'])) $this->cirMonthlyDoW_day = intval($_POST['cirMonthlyDoW_day']);
		if (isset($_POST['cirWeekly_day'])) $this->cirWeekly_day = intval($_POST['cirWeekly_day']);
		if (isset($_POST['cirYearlyDoM_day'])) $this->cirYearlyDoM_day = intval($_POST['cirYearlyDoM_day']);
		if (isset($_POST['cirYearlyDoM_month'])) $this->cirYearlyDoM_month = intval($_POST['cirYearlyDoM_month']);
		if (isset($_POST['cirYearlyDoW_day'])) $this->cirYearlyDoW_day = intval($_POST['cirYearlyDoW_day']);
		if (isset($_POST['cirYearlyDoW_index'])) $this->cirYearlyDoW_index = intval($_POST['cirYearlyDoW_index']);
		if (isset($_POST['cirYearlyDoW_month'])) $this->cirYearlyDoW_month = intval($_POST['cirYearlyDoW_month']);
		...
		if (isset($_POST['commentDays'])) $this->commentDays = intval($_POST['commentDays']);
		if (isset($_POST['commentDaysAfter'])) $this->commentDaysAfter = StringUtil::trim($_POST['commentDaysAfter']);
		if (isset($_POST['commentNoAnswers'])) $this->commentNoAnswers = intval($_POST['commentNoAnswers']);
		if (isset($_POST['commentNoUser'])) $this->commentNoUser = intval($_POST['commentNoUser']);
		if (isset($_POST['commentTypeIDs']) && is_array($_POST['commentTypeIDs'])) $this->commentTypeIDs = ArrayUtil::toIntegerArray($_POST['commentTypeIDs']);
		
		$this->conversationNoAnswers = $this->conversationNoLabels = 0;
		if (isset($_POST['conversationDays'])) $this->conversationDays = intval($_POST['conversationDays']);
		if (isset($_POST['conversationDaysAfter'])) $this->conversationDaysAfter = StringUtil::trim($_POST['conversationDaysAfter']);
		if (isset($_POST['conversationNoAnswers'])) $this->conversationNoAnswers = intval($_POST['conversationNoAnswers']);
		if (isset($_POST['conversationNoLabels'])) $this->conversationNoLabels = intval($_POST['conversationNoLabels']);
		
		// feedreader
		$this->feedreaderUseTags = $this->feedreaderUseTime = 0;
		if (isset($_POST['feedreaderExclude'])) $this->feedreaderExclude = StringUtil::trim($_POST['feedreaderExclude']);
		if (isset($_POST['feedreaderFrequency'])) $this->feedreaderFrequency = intval($_POST['feedreaderFrequency']);
		if (isset($_POST['feedreaderInclude'])) $this->feedreaderInclude = StringUtil::trim($_POST['feedreaderInclude']);
		if (isset($_POST['feedreaderMaxAge'])) $this->feedreaderMaxAge = intval($_POST['feedreaderMaxAge']);
		if (isset($_POST['feedreaderMaxItems'])) $this->feedreaderMaxItems = intval($_POST['feedreaderMaxItems']);
		if (isset($_POST['feedreaderUseTags'])) $this->feedreaderUseTags = intval($_POST['feedreaderUseTags']);
		if (isset($_POST['feedreaderUseTime'])) $this->feedreaderUseTime = intval($_POST['feedreaderUseTime']);
		if (isset($_POST['feedreaderUrl'])) $this->feedreaderUrl = StringUtil::trim($_POST['feedreaderUrl']);
		
		if (isset($_POST['groupAssignmentGroupID'])) $this->groupAssignmentGroupID = intval($_POST['groupAssignmentGroupID']);
		if (isset($_POST['groupAssignmentAction'])) $this->groupAssignmentAction = StringUtil::trim($_POST['groupAssignmentAction']);
		if (isset($_POST['groupChangeGroupIDs']) && is_array($_POST['groupChangeGroupIDs'])) $this->groupChangeGroupIDs = ArrayUtil::toIntegerArray($_POST['groupChangeGroupIDs']);
		$this->groupChangeType = 0;
		if (isset($_POST['groupChangeType'])) $this->groupChangeType= intval($_POST['groupChangeType']);
		
		if (isset($_POST['inactiveAction'])) $this->inactiveAction = StringUtil::trim($_POST['inactiveAction']);
		if (isset($_POST['inactiveBanReason'])) $this->inactiveBanReason = StringUtil::trim($_POST['inactiveBanReason']);
		if (isset($_POST['inactiveReminderLimit'])) $this->inactiveReminderLimit = intval($_POST['inactiveReminderLimit']);
		
		if (isset($_POST['likeAction'])) $this->likeAction = StringUtil::trim($_POST['likeAction']);
		
		if (isset($_POST['userCount'])) $this->userCount = StringUtil::trim($_POST['userCount']);
		if (isset($_POST['userCreationGroupID'])) $this->userCreationGroupID = intval($_POST['userCreationGroupID']);
		...
		if (isset($_POST['userSettingAvatarOption'])) $this->userSettingAvatarOption = intval($_POST['userSettingAvatarOption']);
		if (isset($_POST['userSettingCover'])) $this->userSettingCover = intval($_POST['userSettingCover']);
		if (isset($_POST['userSettingEmail'])) $this->userSettingEmail = intval($_POST['userSettingEmail']);
		if (isset($_POST['userSettingOther'])) $this->userSettingOther = intval($_POST['userSettingOther']);
		if (isset($_POST['userSettingSelfDeletion'])) $this->userSettingSelfDeletion = intval($_POST['userSettingSelfDeletion']);
		if (isset($_POST['userSettingSignature'])) $this->userSettingSignature = intval($_POST['userSettingSignature']);
		if (isset($_POST['userSettingUsername'])) $this->userSettingUsername = intval($_POST['userSettingUsername']);
		if (isset($_POST['userSettingUserTitle'])) $this->userSettingUserTitle = intval($_POST['userSettingUserTitle']);
	}
	...
	public function validate() {
		...
		if (empty($this->botTitle)) throw new UserInputException('botTitle', 'required');
		if (mb_strlen($this->botTitle) > 80) throw new UserInputException('botTitle', 'tooLong');
		
		// bot description not required, max 255 chars
		if (mb_strlen($this->botDescription) > 255) throw new UserInputException('botDescription', 'tooLong');
		
		// bot category must exist
		if (!$this->categoryID) throw new UserInputException('categoryID', 'missing');
		$category = new Category($this->categoryID);
		if (!$category->categoryID) throw new UserInputException('categoryID', 'notValid');
		...
		// switch off condense
		if (!$this->type->canCondense) $this->condenseEnable = 0;
		
		// feedreader
		if ($this->type->typeTitle == 'system_feedreader') {
			if (empty($this->feedreaderUrl)) throw new UserInputException('feedreaderUrl');
			...
			if ($result['statusCode'] != 200) throw new UserInputException('feedreaderUrl', 'invalid');
		}
		...
		// notify may exist
		if ($this->type->needNotify && !$this->notifyID) throw new UserInputException('notifyID', 'missing');
		if ($this->notifyID) {
			...
			if ($this->notify->notifyTitle == 'email') {
				if (!empty($this->emailBCC)) {
					...
					foreach ($emails as $email) {
						if (!UserUtil::isValidEmail($email)) throw new UserInputException('emailBCC', 'notValid');
					}
				}
				...
				if (!empty($this->emailCC)) {
					...
					foreach ($emails as $email) {
						if (!UserUtil::isValidEmail($email)) throw new UserInputException('emailCC', 'notValid');
					}
				}
			}
			...
			if ($this->isMultilingual) {
				foreach ($this->availableLanguages as $language) {
					if ($this->notify->hasSubject == 1 && empty($this->subject[$language->languageID])) throw new UserInputException('subject'.$language->languageID);
					...
					if ($this->condenseEnable == 1 && empty($this->condense[$language->languageID])) throw new UserInputException('condense'.$language->languageID);
				}
			}
			else {
				if ($this->notify->hasSubject == 1 && empty($this->subject[0])) throw new UserInputException('subject');
				...
				if ($this->condenseEnable == 1 && empty($this->condense[0])) throw new UserInputException('condense');
			}
		}
		...
		if (mb_strlen($this->inactiveBanReason) > 60000) $this->inactiveBanReason = mb_substr($this->inactiveBanReason, 0, 60000) . ' ...';
		...
		if ($this->type->typeTitle == 'user_setting') {
			...
			if (!$sum) throw new UserInputException('userSetting', 'notConfigured');
		}
