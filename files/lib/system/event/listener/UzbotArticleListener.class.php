		...
		if ($action == 'create') {
			...
			foreach ($contents as $content) {
				...
				foreach ($bots as $bot) {
					...
					if ($bot->articlePublished && $article->publicationStatus != Article::PUBLISHED) continue;
					
					// skip articles not matching category
					if ($bot->articleConditionCategoryID && $article->categoryID !== $bot->articleConditionCategoryID) continue;
