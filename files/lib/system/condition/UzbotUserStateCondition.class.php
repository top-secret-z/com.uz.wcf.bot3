    ...
    public function checkUser(Condition $condition, User $user)
    {
        ...
        if ($userIsBotEnabled !== null) {
            if ($userIsBotEnabled && $user->activationCode) {
                return false;
            } elseif (!$userIsBotEnabled && !$user->activationCode) {
                return false;
            }
        }
...
HTML;
    ...
    {
        if (isset($_POST['userIsBotBanned'])) {
            $this->userIsBotBanned = 1;
        }
        if (isset($_POST['userIsNotBotBanned'])) {
            $this->userIsNotBotBanned = 1;
        }
        if (isset($_POST['userIsBotDisabled'])) {
            $this->userIsBotDisabled = 1;
        }
        if (isset($_POST['userIsBotEnabled'])) {
            $this->userIsBotEnabled = 1;
        }
        if (isset($_POST['userIsBotReminded'])) {
            $this->userIsBotReminded = 1;
        }
        if (isset($_POST['userIsNotBotReminded'])) {
            $this->userIsNotBotReminded = 1;
        }
    }
