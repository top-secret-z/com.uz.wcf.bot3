...
HTML;
    ...
    protected function getUserGroups()
    {
        if ($this->userGroups == null) {
            ...
            \uasort($this->userGroups, static function (UserGroup $groupA, UserGroup $groupB) {
    ...
    {
        if (isset($_POST['receiverBotGroupIDs'])) {
            $this->receiverBotGroupIDs = ArrayUtil::toIntegerArray($_POST['receiverBotGroupIDs']);
        }
        if (isset($_POST['notReceiverBotGroupIDs'])) {
            $this->notReceiverBotGroupIDs = ArrayUtil::toIntegerArray($_POST['notReceiverBotGroupIDs']);
        }
    }
