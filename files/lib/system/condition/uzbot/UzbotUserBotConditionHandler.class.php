...
/**
 * Handles bot user conditions.
 */
class UzbotUserBotConditionHandler extends SingletonFactory
{
    /**
    ...
    {
        $objectTypes = ObjectTypeCache::getInstance()->getObjectTypes('com.uz.wcf.bot.condition.userBot');
